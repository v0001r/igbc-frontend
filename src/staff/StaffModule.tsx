...
import LeadProjectDetailPage from "./pages/LeadProjectDetailPage";
  ...
  return (
    ...
    >
      <Routes>
        ...
        <Route
          path="lead"
          element={isLead ? <LeadAssignmentsPage /> : <Navigate to="/staff" replace />}
        />
        <Route
          path="lead/projects/:id"
          element={isLead ? <LeadProjectDetailPage /> : <Navigate to="/staff" replace />}
        />

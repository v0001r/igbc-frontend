...
const STATUS_LABELS: Record<string, string> = {
  ...
  tpa_review_in_progress: "TPA Review In Progress",
  tpa_report_released: "TPA Report Released",
  coordinator_review_in_progress: "Coordinator Review",
  coordinator_report_released: "Coordinator Report Released",
  client_review_pending: "Client Review Pending",
  client_accepted: "Client Accepted",
  client_rejected: "Client Rejected",
  reappeal_in_progress: "Reappeal In Progress",
